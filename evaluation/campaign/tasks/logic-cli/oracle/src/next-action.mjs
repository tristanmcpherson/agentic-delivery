...
export function selectNextAction(input) {
  ...
  if (input.current_status === "implemented-not-verified") return { kind: "promote-local-verification" };
  if (input.current_status === "locally-verified") return { kind: "request-protected-verification" };
  if (input.current_status === "closure-verified") return { kind: "request-delivery-verification" };
  throw new Error("No valid transition remains");
}
