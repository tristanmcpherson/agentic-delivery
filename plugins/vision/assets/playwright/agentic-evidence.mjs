...
export async function captureStableScreenshot(page, file) {
  ...
  throw new Error("screenshot did not reach two consecutive hash-identical frames after 8 attempts");
}
...
export const test = base.extend({
  agenticEvidence: [async ({ page, context }, use, testInfo) => {
    ...
    try {
      ...
      await captureStableScreenshot(page, finalImage);
