...
```powershell
node .agentic/bin/agentic-lifecycle.mjs activate --task <task> --goal-intent <sha256> --bead <id> --slice <slice-id>
```
...
10. Complete the goal only when its declared completion target has actually been reached.
